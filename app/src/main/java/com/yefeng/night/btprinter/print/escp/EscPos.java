package com.yefeng.night.btprinter.print.escp;
...
import com.yefeng.night.btprinter.print.escp.params.*;
...
public class EscPos {
    ...
    public EscPos(BluetoothSocket socket)throws IOException {
    ...
    */
    ...
    public static synchronized EscPos getInstance(BluetoothSocket socket) throws IOException{
        if(escPos == null){
            escPos = new EscPos(socket);
        }
        return escPos;
    }
